...
const HistoryView: React.FC<HistoryViewProps> = ({ history, sections }) => {
    ...
    <div className="space-y-12 animate-in fade-in duration-700">
      ...
      <div className="glass-blueprint p-8 rounded-[2rem] border-2 border-cyan-400/20 flex flex-col md:flex-row justify-between items-center bg-gradient-to-r from-cyan-950/20 to-transparent">
        <div className="flex items-center space-x-6">
           <div className="bg-cyan-500/10 p-5 rounded-2xl border-2 border-cyan-500/40 shadow-[0_0_20px_rgba(34,211,238,0.2)]">
           ...
           <div>
             <h2 className="text-3xl font-brand font-black text-white tracking-tighter uppercase">History Logs</h2>
             <p className="text-[10px] font-mono-tech text-cyan-400 tracking-[0.5em] uppercase font-bold">Temporal Personnel Tracking Core</p>
           </div>
        </div>
        ...
        <div className="mt-8 md:mt-0 text-right p-6 bg-slate-950/60 rounded-3xl border border-white/5 min-w-[300px] shadow-[0_0_30px_rgba(0,0,0,0.5)]">
            <p className="text-[11px] font-mono-tech text-cyan-400 uppercase font-black tracking-widest mb-2">Live Temporal Reference</p>
      ...
      <div className="flex items-center justify-between">
          <h2 className="text-[12px] uppercase font-mono-tech font-black tracking-[0.8em] text-cyan-500/80">Operational_History_Stream [Active]</h2>
            ...
            >
              ...
              <div className="flex-1 grid grid-cols-1 md:grid-cols-4 gap-8 w-full">
                <div className="flex flex-col justify-center">
                   <p className="text-[10px] font-mono-tech uppercase text-slate-500 tracking-widest mb-1">Entry_Time</p>
                   <p className="text-xl font-mono-tech font-black text-white">{time}</p>
                </div>
                
                <div className="flex flex-col justify-center">
                   <p className="text-[10px] font-mono-tech uppercase text-slate-500 tracking-widest mb-1">Section_Node</p>
                   <p className="text-xl font-brand font-black text-cyan-400">{getSectionName(record.sectionId)}</p>
                </div>

                <div className="flex flex-col justify-center">
                   <p className="text-[10px] font-mono-tech uppercase text-slate-500 tracking-widest mb-1">Authorized_Reporting</p>
                ...
                <div className="flex flex-col justify-center items-end pr-8">
                   <p className="text-[10px] font-mono-tech uppercase text-cyan-500 tracking-widest mb-1">Sync_Count</p>
              ...
              <div className="absolute top-4 right-4">
                 <div className="bg-emerald-500/10 px-3 py-1 rounded-full border border-emerald-500/20">
                    <span className="text-[8px] font-mono-tech text-emerald-400 font-black uppercase tracking-widest">Validated_Sync</span>
                 </div>
              </div>
      ...
      <div className="text-center py-20 opacity-30">
          <p className="text-[10px] font-mono-tech uppercase tracking-[1em] text-slate-500">History Stream Terminal</p>
      </div>
    </div>
  );
};
